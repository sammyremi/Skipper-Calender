...
export default function OurStorySection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-12 left-1/2 -translate-x-1/2 text-[15vw] font-serif font-bold text-charcoal-900/[0.03] select-none pointer-events-none tracking-tighter uppercase whitespace-nowrap">
        OUR STORY
      </div>
          ...
          {STORY_CHAPTERS.map((chapter, idx) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white bg-charcoal-950 group">
                    ...
                    <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-md px-3.5 py-1.5 rounded-full text-xs font-sans font-medium text-charcoal-900 flex items-center gap-1.5 shadow-sm">
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <span className="text-xs uppercase tracking-widest text-charcoal-900/50 font-sans font-semibold border-l border-babyBlue-200 pl-4 py-1">
                      {chapter.subtitle}
                    </span>
                  </div>

                  <h3 className="font-serif text-3xl md:text-5xl text-charcoal-900 font-semibold leading-tight">
                    {chapter.title}
                  </h3>

                  <p className="text-charcoal-900/70 text-base md:text-lg font-sans leading-relaxed">
                    {chapter.description}
                  </p>

                  <div className="pt-2 flex items-center gap-2 text-xs font-sans text-babyBlue-600 font-medium uppercase tracking-wider">
